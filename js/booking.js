...
const serviceDetails = {
  commercial: {
    ...
    list: ["تأسيس الشركات بجميع أنواعها وصياغة لوائحها الداخلية وعقود التأسيس.", "صياغة ومراجعة العقود والاتفاقيات التجارية ومحاضر مجالس الإدارة.", "التمثيل القضائي والرفع والترافع في المنازعات والنزاعات التجارية.", "التسوية الودية للخلافات التجارية بين الشركاء أو الشركات.", "التأكد من الامتثال الكامل للأنظمة واللوائح وتقديم الاستشارات الاستباقية للمستثمرين."]
  },
  civil: {
